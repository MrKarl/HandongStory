...
public class HorizontialListView extends AdapterView<ListAdapter> {
        ...
        protected boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                                float velocityY) {
        	float curi = getScrollX();
                synchronized(HorizontialListView.this){
                        mScroller.fling(mNextX, 0, (int)-velocityX, 0, 0, mMaxX, 0, 0);
                }
                /*
                if((float)1000/curi > 2){
                	this.scrollBy(1000,0);
                }else{
                	this.scrollBy(-1000, 0);
                }
                */
        ...
        private OnGestureListener mOnGesture = new GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                	...
                	/*
                        Log.d("msg","fling2");
	                	float toMoveDistance = getWidth() - Math.abs(mNextX);
	                	...
	                	return HorizontialListView.this.onFling(e1, e2, revisedVelocityX, velocityY);
                	중력가속도코드........
                	*/
                }
