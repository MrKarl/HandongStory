...
$points = array();
array_push($points, 13251);
$names = array();
array_push($names, "FireFox");
 /* Create and populate the pData object */
 $MyData = new pData();  
 $MyData->addPoints($points,"Hits");
 $MyData->setAxisName(0,"Hits");
 $MyData->addPoints($names,"Browsers");
 ...
 $myPicture->autoOutput("./chan/pChart2.1.3/examples/pictures/example.drawBarChart.palette.png");
?>